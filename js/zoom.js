...
var zoom = (function(){
  ...
  function drag(event) {
    ...
    currentTranslateX = dragStartTranslateX + dx / level;
    currentTranslateY = dragStartTranslateY + dy / level;
    document.body.style.transform = `translate(${currentTranslateX}px, ${currentTranslateY}px) scale(${level})`;
  }
  ...
  function magnify(rect, scale) {
    ...
    if (supportsTransforms) {
      ...
      // Scale
        ...
        var transform = `translate(${currentTranslateX}px, ${currentTranslateY}px) scale(${scale})`;
    ...
    to: function (options) {
      ...
      if (level !== 1) {
        ...
        if (options.scale > 1) {
          ...
          // Set initial translate to center the zoomed area
          currentTranslateX = -options.x;
          currentTranslateY = -options.y;
          magnify(options, options.scale);
          // Add drag listener only when zooming in
